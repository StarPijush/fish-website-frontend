...
export default function ProductCarousel({ fish, cart, updateQuantity }: ProductCarouselProps) {
    ...
    <section className="py-12 bg-gradient-to-b from-background to-card relative overflow-hidden min-h-screen">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          {/* Right Side Product (Low Opacity) */}
          ...
          {fish.map((_, index) => (
            <button
              ...
              className={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${
                index === currentIndex
                  ? 'bg-primary w-8' :'bg-foreground/30 hover:bg-foreground/50'
              }`}
